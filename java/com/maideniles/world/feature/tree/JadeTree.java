...
public class JadeTree extends Tree {
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(JADE_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(JADE_TREE_VINES_CONFIG);
