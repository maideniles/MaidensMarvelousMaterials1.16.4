...
public class JacarandaTree extends Tree {
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(JACARANDA_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(JACARANDA_TREE_VINES_CONFIG);
