...
public class PaulowniaTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig PAULOWNIA_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.PAULOWNIA_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.PAULOWNIA_LEAVES.get().getDefaultState()),
    ...
    public static final BaseTreeFeatureConfig PAULOWNIA_TREE_VINES_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.PAULOWNIA_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.PAULOWNIA_LEAVES.get().getDefaultState()),
            new BlobFoliagePlacer(FeatureSpread.func_242252_a(LEAVES_RADIUS),
                    FeatureSpread.func_242252_a(LEAVES_OFFSET), LEAVES_HEIGHT),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(PAULOWNIA_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(PAULOWNIA_TREE_VINES_CONFIG);
