...
public class CrabappleTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig CRABAPPLE_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CRABAPPLE_LOG.get().getDefaultState()),
                    new SimpleBlockStateProvider(ModBlocks.CRABAPPLE_LEAVES.get().getDefaultState()),
    ...
    public static final BaseTreeFeatureConfig CRABAPPLE_TREE_VINES_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CRABAPPLE_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.CRABAPPLE_LEAVES.get().getDefaultState()),
            new BlobFoliagePlacer(FeatureSpread.func_242252_a(LEAVES_RADIUS),
                    FeatureSpread.func_242252_a(LEAVES_OFFSET), LEAVES_HEIGHT),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(CRABAPPLE_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(CRABAPPLE_TREE_VINES_CONFIG);
