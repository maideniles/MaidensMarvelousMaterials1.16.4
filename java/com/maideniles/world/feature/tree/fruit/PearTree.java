...
public class PearTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig PEAR_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CEDAR_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.GROWING_PEAR_LEAVES.get().getDefaultState()),
    ...
    public static final BaseTreeFeatureConfig PEAR_TREE_BIG_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CEDAR_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.GROWING_PEAR_LEAVES.get().getDefaultState()),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(PEAR_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(PEAR_TREE_BIG_CONFIG);
