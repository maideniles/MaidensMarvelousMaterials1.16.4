...
public class PeachTree extends Tree {
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(PEACH_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(PEACH_TREE_BIG_CONFIG);
