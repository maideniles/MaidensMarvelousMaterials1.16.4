...
public class LimeTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig LIME_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CEDAR_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.GROWING_LIME_LEAVES.get().getDefaultState()),
    ...
    public static final BaseTreeFeatureConfig LIME_TREE_BIG_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CEDAR_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.GROWING_LIME_LEAVES.get().getDefaultState()),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(LIME_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(LIME_TREE_BIG_CONFIG);
