...
public class CherryTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig CHERRY_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            ...
            new SimpleBlockStateProvider(ModBlocks.GROWING_CHERRY_LEAVES.get().getDefaultState()),
    ...
    public static final BaseTreeFeatureConfig CHERRY_TREE_BIG_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(ModBlocks.CEDAR_LOG.get().getDefaultState()),
            new SimpleBlockStateProvider(ModBlocks.GROWING_CHERRY_LEAVES.get().getDefaultState()),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(CHERRY_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(CHERRY_TREE_BIG_CONFIG);
