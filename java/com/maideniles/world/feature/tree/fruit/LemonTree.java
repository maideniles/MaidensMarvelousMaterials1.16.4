...
public class LemonTree extends Tree {
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(MaidensTreeFeature.TREE.withConfiguration(LEMON_TREE_CONFIG)):
                MaidensTreeFeature.TREE.withConfiguration(LEMON_TREE_BIG_CONFIG);
