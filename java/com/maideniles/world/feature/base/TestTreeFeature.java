...
public class TestTreeFeature extends Feature<BaseTreeFeatureConfig> {

    public TestTreeFeature(Codec<BaseTreeFeatureConfig> configFactory) {
        super(configFactory);
    }
    ...
    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, BaseTreeFeatureConfig config) {
        ...
        IChunk cachedChunk = reader.getChunk(blockpos);
        Direction treeFacing = Direction.byHorizontalIndex(rand.nextInt(4));
    ...
    private boolean place(IWorldGenerationReader generationReader, Random rand, BlockPos positionIn, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox boundingBoxIn, BaseTreeFeatureConfig configIn) {    int i = configIn.trunkPlacer.func_236917_a_(rand);
    ...
    public static boolean isDirtOrFarmlandAt(IWorldGenerationBaseReader p_236418_0_, BlockPos p_236418_1_) {
        return p_236418_0_.hasBlockState(p_236418_1_, (p_236409_0_) -> {
            ...
            return isDirt(block) || block.isIn(BlockTags.SAND) || block == ModBlocks.ORNAMENTAL_GRASS.get();
        });
    }
