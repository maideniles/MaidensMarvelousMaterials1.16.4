...
public class GrowingCherryLeavesBlock extends BushBlock implements IGrowable {
    ...
    public GrowingCherryLeavesBlock(Block.Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.GROWING_CHERRY_LEAVES.get()
