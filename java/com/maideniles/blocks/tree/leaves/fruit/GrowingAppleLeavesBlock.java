...
public class GrowingAppleLeavesBlock extends BushBlock implements IGrowable {
    ...
    public GrowingAppleLeavesBlock(Block.Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR || block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.GROWING_APPLE_LEAVES.get()
