...
public class GrowingPeachLeavesBlock extends BushBlock implements IGrowable {
    ...
    public GrowingPeachLeavesBlock(Block.Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.GROWING_PEACH_LEAVES.get()
