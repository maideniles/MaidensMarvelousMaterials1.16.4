...
public class GrowingOrangeLeavesBlock extends BushBlock implements IGrowable {
    ...
    public GrowingOrangeLeavesBlock(Block.Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.GROWING_ORANGE_LEAVES.get()
