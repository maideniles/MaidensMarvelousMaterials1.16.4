...
import com.maideniles.maidensmaterials.init.ModContainers;
...
public class MaidensChestContainer extends Container
{
    ...
    public MaidensChestContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player)
    {
        super(ModContainers.PINK_CHEST_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn)
    {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(),
                tileEntity.getPos()), playerEntity, ModBlocks.PINK_CHEST.get());
    }
    ...
    {
        return ((MaidensChestTileEntity) this.tileEntity).getEnergyLevel();
    }
}