...
public class BaseChestBlock extends Block implements IWaterLoggable {
    ...
    public BaseChestBlock(MaidensChestTypes typeIn, Supplier<TileEntityType<? extends TestChestTileEntity>> tileEntityTypeSupplierIn, Properties propertiesIn) {
        super(propertiesIn);
    ...
    public TileEntityMerger.ICallbackWrapper<? extends TestChestTileEntity> getWrapper(BlockState blockState, World world, BlockPos blockPos, boolean p_225536_4_) {
        ...
        return TileEntityMerger.func_226924_a_(this.tileEntityTypeSupplier.get(), BaseChestBlock::getMergerType, BaseChestBlock::getDirectionToAttached, FACING, blockState, world, blockPos, biPredicate);
    }
