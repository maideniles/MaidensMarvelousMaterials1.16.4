...
public class GrowingPearLeavesBlock extends BushBlock implements IGrowable {
    ...
    public GrowingPearLeavesBlock(Block.Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.GROWING_PEAR_LEAVES.get()|| block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.FARMLAND || block == Blocks.SAND || block.isIn(BlockTags.LEAVES);
    }
