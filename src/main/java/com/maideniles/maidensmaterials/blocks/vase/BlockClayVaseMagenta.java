    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote()) {
          ...
          //      System.out.println("APPLE SAPLING!");
           ...
           //     System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.MAGENTA_VASE_PLUM_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.ORANGE_FRUIT_SAPLING.get())){

           //    System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.MAGENTA_VASE_ORANGE_FRUIT_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.GRAPEFRUIT_SAPLING.get())){

            //    System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.MAGENTA_VASE_GRAPEFRUIT_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.LEMON_SAPLING.get())){

           //     System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.MAGENTA_VASE_LEMON_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.LIME_SAPLING.get())){

           //     System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.MAGENTA_VASE_LIME_FRUIT_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.CHERRY_SAPLING.get())){

           //     System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.MAGENTA_VASE_CHERRY_SAPLING.get().getDefaultState());
            }
