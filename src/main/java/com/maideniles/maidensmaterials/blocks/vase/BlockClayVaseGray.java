...
public class BlockClayVaseGray extends Block {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
       ...
       //         System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.GRAY_VASE_PLUM_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.ORANGE_FRUIT_SAPLING.get())){

        //        worldIn.setBlockState(pos, ModBlocks.GRAY_VASE_ORANGE_FRUIT_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.GRAPEFRUIT_SAPLING.get())){

       //         System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.GRAY_VASE_GRAPEFRUIT_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.LEMON_SAPLING.get())){

        //        System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.GRAY_VASE_LEMON_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.LIME_SAPLING.get())){

        //        System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.GRAY_VASE_LIME_FRUIT_SAPLING.get().getDefaultState());
            }

            if (blossom.getItem() == Item.getItemFromBlock(ModBlocks.CHERRY_SAPLING.get())){

       //         System.out.println("APPLE SAPLING!");
                worldIn.setBlockState(pos, ModBlocks.GRAY_VASE_CHERRY_SAPLING.get().getDefaultState());
            }
