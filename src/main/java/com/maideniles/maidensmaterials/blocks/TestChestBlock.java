...
public class TestChestBlock extends Block implements IWaterLoggable {
    ...
    private final TestChestTypes type;
    private final Supplier<TileEntityType<? extends TestChestTileEntity>> tileEntityTypeSupplier;

    public TestChestBlock(TestChestTypes typeIn, Supplier<TileEntityType<? extends TestChestTileEntity>> tileEntityTypeSupplierIn, Properties propertiesIn) {
        super(propertiesIn);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (tileentity instanceof TestChestTileEntity) {
            ...
            if (stack.hasDisplayName()) {
                ((TestChestTileEntity) tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (tileentity instanceof TestChestTileEntity) {
                ...
                InventoryHelper.dropInventoryItems(worldIn, pos, (TestChestTileEntity) tileentity);
    ...
    public static TestChestTypes getTypeFromItem(Item itemIn) {
        return getTypeFromBlock(Block.getBlockFromItem(itemIn));
    }

    public static TestChestTypes getTypeFromBlock(Block blockIn) {
        return blockIn instanceof TestChestBlock ? ((TestChestBlock) blockIn).getType() : null;
    }

    public TestChestTypes getType() {
        return this.type;
    }
    ...
    public TileEntityMerger.ICallbackWrapper<? extends TestChestTileEntity> getWrapper(BlockState blockState, World world, BlockPos blockPos, boolean p_225536_4_) {
        ...
        if (p_225536_4_) {
            ...
            biPredicate = TestChestBlock::isBlocked;
        }

        return TileEntityMerger.func_226924_a_(this.tileEntityTypeSupplier.get(), TestChestBlock::getMergerType, TestChestBlock::getDirectionToAttached, FACING, blockState, world, blockPos, biPredicate);
    }
