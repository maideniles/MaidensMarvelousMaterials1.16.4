...
@OnlyIn(Dist.CLIENT)
public class TestChestScreen extends ContainerScreen<TestChestContainer> implements IHasContainer<TestChestContainer> {
    ...
    public TestChestScreen(TestChestContainer container, PlayerInventory playerInventory, ITextComponent title) {
