...
public class CyanChestTileEntity extends TestChestTileEntity {
    ...
    public CyanChestTileEntity() {
        super(TestChestTileEntityTypes.CYAN_CHEST.get(), TestChestTypes.CYAN, TestChestBlocks.CYAN_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return TestChestContainer.createCyanContainer(id, playerInventory, this);
    }
}