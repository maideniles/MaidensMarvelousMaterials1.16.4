...
public class OrangeChestTileEntity extends TestChestTileEntity {
    ...
    public OrangeChestTileEntity() {
        super(MaidensChestTileEntityTypes.ORANGE_CHEST.get(), MaidensChestTypes.ORANGE, MaidensChestBlocks.ORANGE_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return MaidensChestContainer.createOrangeContainer(id, playerInventory, this);
    }
}