...
public class LightBlueChestTileEntity extends TestChestTileEntity {
    ...
    public LightBlueChestTileEntity() {
        super(MaidensChestTileEntityTypes.LIGHT_BLUE_CHEST.get(), MaidensChestTypes.LIGHT_BLUE, MaidensChestBlocks.LIGHT_BLUE_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return MaidensChestContainer.createLightBlueContainer(id, playerInventory, this);
    }
}
