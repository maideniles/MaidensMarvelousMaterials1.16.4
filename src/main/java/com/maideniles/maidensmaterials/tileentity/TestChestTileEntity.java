...
public class TestChestTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity {
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent(MaidensMaterials.MOD_ID + ".container." + this.chestType.getId() + "_chest");
    }
