...
public class LightGrayChestTileEntity extends TestChestTileEntity {
    ...
    public LightGrayChestTileEntity() {
        super(MaidensChestTileEntityTypes.LIGHT_GRAY_CHEST.get(), MaidensChestTypes.LIGHT_GRAY, MaidensChestBlocks.LIGHT_GRAY_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return MaidensChestContainer.createLightGrayContainer(id, playerInventory, this);
    }
}