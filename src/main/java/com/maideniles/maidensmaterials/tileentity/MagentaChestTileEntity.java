...
public class MagentaChestTileEntity extends TestChestTileEntity {
    ...
    public MagentaChestTileEntity() {
        super(MaidensChestTileEntityTypes.MAGENTA_CHEST.get(), MaidensChestTypes.MAGENTA, MaidensChestBlocks.MAGENTA_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return MaidensChestContainer.createMagentaContainer(id, playerInventory, this);
    }
}
