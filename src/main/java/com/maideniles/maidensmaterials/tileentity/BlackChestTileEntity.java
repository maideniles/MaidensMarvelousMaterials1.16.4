...
public class BlackChestTileEntity extends TestChestTileEntity {
    ...
    public BlackChestTileEntity() {
        super(MaidensChestTileEntityTypes.BLACK_CHEST.get(), MaidensChestTypes.BLACK, MaidensChestBlocks.BLACK_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return MaidensChestContainer.createBlackContainer(id, playerInventory, this);
    }
}