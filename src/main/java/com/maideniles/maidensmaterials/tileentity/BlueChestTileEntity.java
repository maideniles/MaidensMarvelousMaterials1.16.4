...
public class BlueChestTileEntity extends TestChestTileEntity {
    ...
    public BlueChestTileEntity() {
        super(TestChestTileEntityTypes.BLUE_CHEST.get(), TestChestTypes.BLUE, TestChestBlocks.BLUE_CHEST::get);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return TestChestContainer.createBlueContainer(id, playerInventory, this);
    }
}