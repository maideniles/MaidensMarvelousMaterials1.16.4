...
public class LaburnumChestTileEntity extends TestChestTileEntity {

    public LaburnumChestTileEntity() {
        super(MaidensChestTileEntityTypes.LABURNUM_CHEST.get(), MaidensChestTypes.LABURNUM, MaidensChestBlocks.LABURNUM_CHEST::get);
    }
