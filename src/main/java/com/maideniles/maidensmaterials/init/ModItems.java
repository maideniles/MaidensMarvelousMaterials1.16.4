...
public class ModItems {
    ...
    public static final RegistryObject<Item> PRUNING_SHEARS = Registration.ITEMS.register("pruning_shears",
            () -> new Item(new Item.Properties().group(MaidensMaterials.MAIDENS_ITEMS_GROUP).maxDamage(48)));
...
//FRUITS//
    ...
    {
       AMETHYST(50, new int[] { 3, 6, 4, 3 }, 1, SoundEvents.ITEM_ARMOR_EQUIP_IRON,
                Ingredient.fromStacks(new ItemStack(ModItems.AMETHYST_CHUNK.get())),
                MaidensMaterials.MOD_ID + ":amethyst", 0, 0.1f);
