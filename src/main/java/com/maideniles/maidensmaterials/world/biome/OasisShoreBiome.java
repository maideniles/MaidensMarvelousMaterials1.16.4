...
public class OasisShoreBiome {
    ...
    public static Biome makeOasisShoreBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
     ...
     //   biomegenerationsettings$builder.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION.ordinal(), () -> ModConfiguredFeatures.CORAL_FAN_OASIS_CONFIG);
        ...
        biomegenerationsettings$builder.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION.ordinal(), () -> ModConfiguredFeatures.PALM_TREE_CONFIGURED_FEATURE_BEES_WG);
