...
public class CedarTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig CEDAR_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            ...
            new SimpleBlockStateProvider(ModBlocks.GREEN_CLAY_BLOCK.get().getDefaultState()),
            ...
            .setDecorators(ImmutableList.of( new MaidensCoconutDecorator(50f),
    ...
    public static final BaseTreeFeatureConfig CEDAR_TREE_VINES_CONFIG = (new BaseTreeFeatureConfig.Builder(
            ...
            .setDecorators(ImmutableList.of(
                    new MaidensCoconutDecorator(50f),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean largeHive) {
        ...
        return randomIn.nextInt(6)==0 ?(Feature.TREE.withConfiguration(CEDAR_TREE_CONFIG)):
                Feature.TREE.withConfiguration(CEDAR_TREE_VINES_CONFIG);
